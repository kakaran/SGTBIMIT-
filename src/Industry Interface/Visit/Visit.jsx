        ...
        <>
            ...
            >
                <div className='w-[min(1500px,98%)] mx-auto'>
                    <h1 className='my-bold my-text-4 text-center text-[var(--primary-blue)]'>Industrial Visit</h1>
                ...
                <div>
                    <h1 className='my-bold text-5xl max-md:text-3xl text-[var(--primary-blue)] m-0'>Companies Visited</h1>
                    <div className={`${styles.line} w-full h-1 bg-[var(--primary-blue)]`}></div>
